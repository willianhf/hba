        ...
        <div className="flex justify-between items-center py-6 md:justify-start md:space-x-10">
          ...
          <nav className="hidden md:flex space-x-10">
            {navigationItems.map(item => (
              <Button key={item.href} as={Link} variant="link" href={item.href} className="flex items-center hover:text-gray-200">
          ...
          <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
            ...
            <Button as={Link} href="/signup" colorScheme="red" className="ml-8">
              Cadastrar
            </Button>
          </div>
        </div>
        ...
        <Popover.Panel focus className="absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
          <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
            ...
            <div className="py-6 px-5 space-y-6">
              <Button as={Link} href="/signup" colorScheme="blue">
                Cadastrar
              </Button>
              <p className="mt-6 text-center text-base font-medium text-gray-500">
                Já possui cadastro?{' '}
                <Button as={Link} variant="link" href="/login" colorScheme="blue">
                  Entrar
                </Button>
              </p>
            </div>
